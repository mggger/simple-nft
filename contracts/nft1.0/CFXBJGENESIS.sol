...
contract CFXBJGENESIS is ERC1155, Operator {
    ...
    // Contract name
    string public name = "nft_test_contract";
    // Contract symbol
    string public symbol = "nft_test";
    ...
    //设置baseUri,用来获取中心化服务
    constructor() public ERC1155("http://localhost:3000/") {
